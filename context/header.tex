...
after={\removeunwantedspaces\blank[medium]\noindentation
\switchtobodyfont[default]},
leftmargin=4mm, rightmargin=0mm]


\definedelimitedtext[note]
\setupdelimitedtext
        [note]
        [before={\blank[medium]
        \noindentation
...
% \definedelimitedtext[bottomnote]
% \setupdelimitedtext
%         [bottomnote]
%         [before={\blank[medium]
%         \noindentation
...
\defineregister[classical-authors]
\setupregister[classical-authors]
  [compress=yes,
   indicator=no,
   pagestyle=\tf,
   n=1]
