...
\setupdelimitedtext
        ...
        %[before={\blank[big,fixed]\switchtobodyfont[8.5pt]},
after={\removeunwantedspaces%\par
\blank[medium]
\switchtobodyfont[default]},
leftmargin=0pt]
