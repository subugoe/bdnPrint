...
\definefontsynonym[liberSynonym]
  [name: linlibertinemob]
  
\definefont[liber]
  [liberSynonym] 
  
  
% FreeSerif widely supports Unicode characters, e.g. the rotunda  
\definefontsynonym[freeSynonym]
  [name: freeserif]
  
\definefont[freeserif]
  [freeSynonym]  
...
\def\bb{{\switchtobodyfont[8.25pt]\liber\char"005D}}	% 005D: Right square bracket
...
\definebodyfontenvironment[8.25pt]
  [interlinespace=10.5pt, % xx for footnote markers
   a=9.78pt, x=7.23pt, xx=6.59pt]    
...
\definehead[listmainheadrdgfirst][section]
...
\setuphead[listmainheadrdgfirst]  
  [number=no,
  header=high,
  before={\blank[0pt]},
  after={\blank[6pt]},
...
\definedelimitedtext[rdgbeforehead]
\setupdelimitedtext
        [rdgbeforehead]
        [before={\crlf
        \noindentation
